...
// Updates the board matrix and cell variables
...
        // Also update named variables if you need them elsewhere
...
// Reset game
function reset() {
    // Re-enable all cells, clear value, reload matrix and variables
    document.querySelectorAll('.cell').forEach(cell => {
        cell.disabled = false;
        cell.value = "";
    });
